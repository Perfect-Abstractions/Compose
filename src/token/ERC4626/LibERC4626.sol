...
/// @title LibERC4626 — ERC-4626 Library
/// @notice Provides internal functions and storage layout for ERC-4626 token logic.
...
library LibERC4626 {
    ...
    /// @notice ERC-4626 storage layout using the ERC-8042 standard.
    /// @custom:storage-location erc8042:compose.erc4626
