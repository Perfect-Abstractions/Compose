...
description: "Enumerable ERC-721 token management and metadata."
gitSource: "https://github.com/maxnorm/Compose/blob/00106e341b257629f718c654a349c0ad60a7cf8a/src/token/ERC721/ERC721Enumerable/ERC721EnumerableFacet.sol"
---
...
<DocSubtitle>
Enumerable ERC-721 token management and metadata.
</DocSubtitle>

<Callout type="info" title="Key Features">
- Full ERC-721 compliance with enumeration capabilities.
- Supports standard NFT metadata retrieval via `tokenURI`.
- Includes internal transfer logic for integration with other facets.
- Emits standard ERC-721 events for `Transfer`, `Approval`, and `ApprovalForAll`.
</Callout>

## Overview

The ERC721EnumerableFacet provides standard ERC-721 functionality including token enumeration, ownership tracking, and metadata access. It integrates seamlessly into a Compose diamond, offering a comprehensive surface area for NFT operations.
...
contract MyDiamondUser {
    ...
    constructor(address diamondAddress) {
        ...
        // Selector for name() is 0x06395705
        bytes4 nameSelector = 0x06395705;
    ...
    function getTokenURI(uint256 tokenId) external view returns (string memory) {
        return erc721Facet.tokenURI(tokenId);
    }
}`}
</ExpandableCode>
...
- Initialize the `ERC721EnumerableFacet` with the correct owner and token details during diamond deployment.
- When transferring tokens, prefer `safeTransferFrom` for enhanced security, especially when interacting with unknown receiver contracts.
- Ensure proper access control is implemented at the diamond proxy level if certain functions require specific permissions.
</Callout>
...
<LastUpdated date="2025-12-20T03:04:31.449Z" />
