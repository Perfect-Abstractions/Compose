...
gitSource: "https://github.com/maxnorm/Compose/blob/00106e341b257629f718c654a349c0ad60a7cf8a/src/access/OwnerTwoSteps/OwnerTwoStepsFacet.sol"
---
...
- Provides clear functions to view current and pending owners.
</Callout>

## Overview

This facet implements a secure, two-step ownership transfer mechanism for Compose diamonds. It ensures that ownership changes are intentional by requiring both the current owner to initiate a transfer and the new owner to accept it, preventing accidental or unauthorized takeovers.
...
import {IOwnerTwoStepsFacet} from "@compose-protocol/diamond-contracts/contracts/facets/owner/IOwnerTwoStepsFacet.sol";

contract OwnerManager {
    IOwnerTwoStepsFacet public immutable ownerFacet;
...
<LastUpdated date="2025-12-20T03:02:58.542Z" />
