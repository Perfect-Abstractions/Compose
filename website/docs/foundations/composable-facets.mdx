...
// Week 2: Add gasless approvals
MyToken.addFacet(ERC20PermitFacet)

// Month 3: Add cross-chain support
MyToken.addFacet(ERC20BridgableFacet)

// Month 6: Add governance
MyToken.addFacet(GovernanceFacet)
```
