...
import DiamondDiagramLightSVG from '@site/static/img/svg/diamond-diagram-light.svg'
import DiamondDiagramDarkSVG from '@site/static/img/svg/diamond-diagram-dark.svg'
