...
<DocCardGrid columns={2}>
  ...
  <DocCard
    ...
    description="Build your own facets that work seamlessly with existing Compose facets using shared storage layouts and internal logic through Solidity modules."
...
Don't rush through these concepts. Taking time to understand the foundations will make everything else much easier.
</Callout>
