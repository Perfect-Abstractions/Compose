...
Compose is also an open source community of smart contract developers. We are improving and maintaining the software and technology that consists of Compose.
...
Imagine having access to a comprehensive, verified standard library of smart contract components that you can combine like LEGO blocks to build smart contract systems—all deployed once onchain and reused across your projects. That's Compose.
...
- **Reusability**: Deployed once, use everywhere
