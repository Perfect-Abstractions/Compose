...
<DocSubtitle>
**Compose** is a smart contract library that helps developers build modular, upgradeable onchain systems using the [ERC-2535 Diamond](https://eips.ethereum.org/EIPS/eip-2535) standard. It's designed from the ground up for **code clarity**, **reusability**, and **onchain composability**.
</DocSubtitle>
