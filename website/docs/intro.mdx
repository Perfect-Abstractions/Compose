...
slug: /
title: "Introduction"
description: Compose is a general-purpose smart contract library built on the ERC-2535 Diamond standard. It lets developers build modular, upgradeable, and composable smart contract systems using reusable onchain components.
