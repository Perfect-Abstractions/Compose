...
For your new project, instead of deploying new contracts, use the existing onchain smart contracts provided by Compose.
...
## Custom Functionality: Composing with Compose

We recognize that many projects want to create their own unique functionality. And we want to help them do that
...
<DocHero
  ...
  subtitle="Compose is a smart contract library that helps developers create smart contract systems using ERC-2535 Diamonds."
  variant="gradient"
  height="medium"
/>
*/}
