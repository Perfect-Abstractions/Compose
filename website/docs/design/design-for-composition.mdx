...
<ExpandableCode language="solidity" maxLines={15} title="ERC20PermitFacet Storage Implementation">
{`/**
...
<ExpandableCode language="solidity" maxLines={15} title="Complete ERC20StakingFacet Implementation">
{`/**
