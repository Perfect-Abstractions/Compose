...
Past smart contract libraries gave you the source code for smart contracts and expected you to extend or modify that source code and then deploy the smart contract source code to a blockchain. 

Compose is different, We don't do that. We take a different approach.

The approach Compose takes is to design small re-usable smart contracts 
