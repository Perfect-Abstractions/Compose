...
import AnimatedCounter from '@site/src/components/animations/AnimatedCounter';
import Timeline from '@site/src/components/data-display/Timeline';
import ComparisonTable from '@site/src/components/data-display/ComparisonTable';
...
import IconGallery from '@site/src/components/docs/IconGallery';
...
<PropertyTable 
  properties={[
    { name: 'title', type: 'string', required: false, description: 'Optional title for the code showcase' },
...
<PropertyTable 
  properties={[
    { name: 'language', type: 'string', required: false, description: 'Code language for syntax highlighting', default: "'javascript'" },
    { name: 'maxLines', type: 'number', required: false, description: 'Lines visible before collapse', default: '10' },
    { name: 'title', type: 'string', required: false, description: 'Optional code block title', default: 'undefined' },
...
<PropertyTable 
  properties={[
    ...
    { name: 'copyable', type: 'boolean', required: false, description: 'Show copy button', default: 'true' },
    { name: 'prompt', type: 'string', required: false, description: 'Command prompt symbol', default: "'$'" },
    { name: 'language', type: 'string', required: false, description: 'Syntax highlighting language', default: "'bash'" }
  ]}
/>
...
<PropertyTable 
  properties={[
    { name: 'title', type: 'string', required: true, description: 'Accordion header text' },
    { name: 'defaultOpen', type: 'boolean', required: false, description: 'Whether accordion starts expanded', default: 'false' },
    { name: 'variant', type: 'string', required: false, description: "Style variant ('default', 'bordered')", default: "'default'" },
...
<PropertyTable 
  properties={[
    ...
    { name: 'position', type: 'string', required: false, description: "Position ('top', 'bottom', 'left', 'right')", default: "'top'" },
...
<PropertyTable 
  properties={[
    ...
    { name: 'path', type: 'string', required: true, description: 'API endpoint path' },
    { name: 'description', type: 'string', required: false, description: 'Optional description' },
...
<PropertyTable 
  properties={[
    { name: 'properties', type: 'Array', required: true, description: 'Array of property objects' },
    { name: 'showRequired', type: 'boolean', required: false, description: 'Show required column', default: 'true' },
    { name: 'showTypes', type: 'boolean', required: false, description: 'Show type column', default: 'true' },
    { name: 'title', type: 'string', required: false, description: 'Optional table title', default: 'undefined' }
  ]}
/>
...
<PropertyTable 
  properties={[
    { name: 'schema', type: 'Object', required: true, description: 'JSON schema object' },
    { name: 'collapsed', type: 'boolean', required: false, description: 'Start collapsed', default: 'false' },
    { name: 'depth', type: 'number', required: false, description: 'Initial nesting depth', default: '0' }
  ]}
/>
...
<PropertyTable 
  properties={[
    ...
    { name: 'parameters', type: 'Array', required: false, description: 'Parameters' },
    { name: 'response', type: 'Object', required: false, description: 'Example response' }
  ]}
/>
...
<PropertyTable 
  properties={[
    ...
    { name: 'currentStep', type: 'number', required: false, description: 'Current active step (0-based)', default: '0' },
    { name: 'orientation', type: 'string', required: false, description: "Layout ('vertical', 'horizontal')", default: "'vertical'" }
  ]}
/>
...
<PropertyTable 
  properties={[
    { name: 'title', type: 'string', required: false, description: 'Hero title', default: 'undefined' },
    { name: 'subtitle', type: 'string', required: false, description: 'Hero subtitle', default: 'undefined' },
    { name: 'backgroundImage', type: 'string', required: false, description: 'Background image URL', default: 'undefined' },
    { name: 'variant', type: 'string', required: false, description: "Style ('default', 'gradient', 'dark', 'image')", default: "'gradient'" },
    { name: 'height', type: 'string', required: false, description: "Height ('small', 'medium', 'large', 'full')", default: "'medium'" },
    { name: 'children', type: 'ReactNode', required: false, description: 'Additional content', default: 'undefined' }
  ]}
/>
...
<DocCardGrid columns={2}>
  ...
  <DocCard
    ...
    href="/"
    icon={<Icon name="graduation" size={32} />}
    variant="secondary"
  />
  <DocCard
    title="Examples"
    ...
    href="/"
    icon={<Icon name="lightbulb" size={32} />}
    variant="default"
  />
</DocCardGrid>
...
<PropertyTable 
  properties={[
    ...
    { name: 'description', type: 'string', required: false, description: 'Card description', default: 'undefined' },
    { name: 'href', type: 'string', required: false, description: 'Link destination', default: 'undefined' },
    { name: 'icon', type: 'string/ReactNode', required: false, description: 'Icon (emoji or component)', default: 'undefined' },
    { name: 'variant', type: 'string', required: false, description: "Style ('default', 'primary', 'secondary')", default: "'default'" },
    { name: 'size', type: 'string', required: false, description: "Size ('small', 'medium', 'large')", default: "'medium'" },
    { name: 'external', type: 'boolean', required: false, description: 'External link', default: 'false' }
  ]}
/>
...
<PropertyTable 
  properties={[
    { name: 'columns', type: 'number', required: false, description: 'Number of columns (2, 3, 4)', default: '3' },
    { name: 'children', type: 'ReactNode', required: true, description: 'FeatureGridItem components' }
  ]}
/>
...
<PropertyTable 
  showRequired={false}
  properties={[
    { name: 'icon', type: 'string/ReactNode', description: 'Icon (emoji or component)' },
    { name: 'title', type: 'string', description: 'Feature title' },
    { name: 'description', type: 'string', description: 'Feature description' },
    { name: 'href', type: 'string', description: 'Optional link' }
  ]}
/>
...
<PropertyTable 
  showRequired={false}
  properties={[
    { name: 'icon', type: 'string', description: 'Emoji or icon' },
    { name: 'title', type: 'string', description: 'Card title' },
    { name: 'description', type: 'string', description: 'Card description' },
    { name: 'gradient', type: 'string', description: "Gradient variant ('gradientBlue', 'gradientPurple', 'gradientPink', 'gradientGreen')" },
    { name: 'link', type: 'string', description: 'Optional link URL' }
  ]}
/>
...
<PropertyTable 
  properties={[
    { name: 'hover', type: 'boolean', required: false, description: 'Enable hover animation', default: 'false' },
...
<PropertyTable 
  showRequired={false}
  properties={[
    { name: 'value', type: 'string/ReactNode', description: 'Metric value' },
    { name: 'label', type: 'string', description: 'Metric label' },
    { name: 'icon', type: 'string', description: 'Optional icon' },
    { name: 'trend', type: 'Object', description: "Optional trend {direction: 'up'/'down', value: '12%'}" }
  ]}
/>
...
<PropertyTable 
  showRequired={false}
  properties={[
    { name: 'items', type: 'Array', required: true, description: 'Required array of timeline items' }
  ]}
/>
...
<PropertyTable 
  showRequired={false}
  properties={[
    { name: 'features', type: 'Array', description: 'Array of feature objects' },
    { name: 'columns', type: 'Array', description: 'Array of column objects' }
  ]}
/>
...
<PropertyTable 
  showRequired={false}
  properties={[
    { name: 'variant', type: 'string', description: "Gradient variant ('primary', 'secondary', 'accent', 'success')" },
...
<PropertyTable 
  properties={[
    { name: 'variant', type: 'string', required: false, description: 'Style variant', default: "'primary'" },
    { name: 'size', type: 'string', required: false, description: "Size ('small', 'medium', 'large')", default: "'medium'" },
...
<div style={{display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '1rem'}}>
  <GradientButton to="/" variant="primary" size="large">
    Get Started
  </GradientButton>
...
<PropertyTable 
  properties={[
    { name: 'to or href', type: 'string', required: false, description: 'Link destination', default: 'undefined' },
    { name: 'variant', type: 'string', required: false, description: "Style ('primary', 'secondary', 'success', 'outline')", default: "'primary'" },
    { name: 'size', type: 'string', required: false, description: "Size ('small', 'medium', 'large')", default: "'medium'" },
    { name: 'external', type: 'boolean', required: false, description: 'Open in new tab', default: 'false' },
...
<PropertyTable 
  properties={[
    { name: 'end', type: 'number', required: true, description: 'Target number' },
    { name: 'duration', type: 'number', required: false, description: 'Animation duration (ms)', default: '2000' },
    { name: 'prefix', type: 'string', required: false, description: "Prefix (e.g., '$')", default: "''" },
    { name: 'suffix', type: 'string', required: false, description: "Suffix (e.g., '+', 'K')", default: "''" },
    { name: 'separator', type: 'string', required: false, description: 'Thousands separator', default: "','" },
...
<PropertyTable 
  properties={[
    { name: 'date', type: 'string/Date', required: true, description: 'Date value' },
    { name: 'author', type: 'string', required: false, description: 'Optional author', default: 'undefined' },
    { name: 'showAuthor', type: 'boolean', required: false, description: 'Show author name', default: 'false' }
  ]}
/>
...
<PropertyTable 
  properties={[
    { name: 'content', type: 'string/ReactNode', required: true, description: 'Content to analyze' },
    { name: 'wordsPerMinute', type: 'number', required: false, description: 'Reading speed', default: '200' }
  ]}
/>
...
<PropertyTable 
  properties={[
    { name: 'items', type: 'Array', required: true, description: 'Array of related items' },
    { name: 'title', type: 'string', required: false, description: 'Section title', default: "'Related Documentation'" }
  ]}
/>
