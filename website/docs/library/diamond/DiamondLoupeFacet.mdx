...
contract DiamondConsumer {
    ...
    function getFacets() public view returns (DiamondLoupeFacet.Facet[] memory) {
    ...
    function getFacetFunctionSelectors(address _facet) public view returns (bytes4[] memory) {
        IDiamond diamond = IDiamond(DIAMOND_ADDRESS);
...
<LastUpdated date="2025-12-30T20:15:02.969Z" />
