...
import {FacetReplacement} from "@compose/diamond/DiamondUpgradeFacet"; // Assuming FacetReplacement struct is available
...
facetsToReplace[0] = FacetReplacement({facet: address(0x789), selectors: bytes("0x00000000")}); // Replace existing facet
