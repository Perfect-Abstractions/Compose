...
- Functions are explicitly defined for direct calls, avoiding `using` directives for state modification.
...
contract ERC6909Facet {
    ...
    function transferToken(
        ...
        ERC6909Mod.ERC6909Storage storage storagePtr = ERC6909Mod.getStorage();
        storagePtr.transfer(_by, _from, _to, _id, _amount);
    }
    ...
    function approveToken(
        ...
        ERC6909Mod.ERC6909Storage storage storagePtr = ERC6909Mod.getStorage();
        storagePtr.approve(_owner, _spender, _id, _amount);
    }
    ...
    function mintToken(
        ...
        ERC6909Mod.ERC6909Storage storage storagePtr = ERC6909Mod.getStorage();
        storagePtr.mint(_to, _id, _amount);
    }
}`}
</ExpandableCode>
-->
...
- Call internal functions using the `storagePtr.functionName()` pattern.
- Ensure correct access control is implemented in facets before calling these functions.
...
<LastUpdated date="2025-12-30T18:50:41.306Z" />
