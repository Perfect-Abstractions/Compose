...
contract MyERC1155Facet {
    using ERC1155Mod for ERC1155Mod;

    function mintTokens(address _to, uint256 _id, uint256 _value) external {
        ERC1155Mod.mint(_to, _id, _value);
    }

    function safeTransfer(address _from, address _to, uint256 _id, uint256 _value) external {
        ERC1155Mod.safeTransferFrom(_from, _to, _id, _value, msg.sender);
    }

    function burnToken(address _from, uint256 _id, uint256 _value) external {
...
<LastUpdated date="2025-12-30T20:13:46.727Z" />
