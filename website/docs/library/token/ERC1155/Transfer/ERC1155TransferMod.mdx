...
description: "Handles ERC-1155 safe transfers and batch transfers"
...
<DocSubtitle>
Handles ERC-1155 safe transfers and batch transfers
</DocSubtitle>

<Callout type="info" title="Key Features">
- Implements ERC-1155 `safeTransferFrom` and `safeBatchTransferFrom` logic.
- All functions are `internal`, designed for use by other facets.
- Leverages diamond storage for persistent state management.
- Includes necessary validation for ERC-1155 transfers.
</Callout>
...
This module provides internal functions for executing ERC-1155 safe transfers and batch transfers. Facets can import this module to manage token movements, interacting with shared diamond storage to update balances. It enforces ERC-1155 compliance, including validation for approvals and receiver contracts.
...
contract ERC1155TransferFacet {
    ERC1155TransferMod internal transferModule;

    // Assume transferModule is initialized with diamond storage
    ...
    function transferSingleToken(
        ...
        // Call the internal module function to perform the transfer
    ...
    function transferBatchTokens(
        ...
        // Call the internal module function to perform the batch transfer
...
- Ensure caller has necessary approvals before invoking transfer functions.
- Verify receiver contract implements ERC1155TokenReceiver if it is a contract address.
...
<LastUpdated date="2026-03-13T01:17:41.336Z" />
