...
// Assume diamondAddress is the address of your deployed Compose diamond
// Assume owner, spender, amount, deadline, v, r, s are defined
...
contract ExampleUsage {
    ...
    function grantPermit(address _owner, address _spender, uint256 _value, uint256 _deadline, uint8 _v, bytes32 _r, bytes32 _s) public {
...
<LastUpdated date="2025-12-30T20:13:22.072Z" />
