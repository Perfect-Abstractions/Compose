...
contract MyPermitFacet {
    using ERC20PermitMod for ERC20PermitMod;

    function examplePermit(address _owner, address _spender, uint256 _value, uint256 _deadline, uint8 _v, bytes32 _r, bytes32 _s) external {
        // This call would typically be part of a larger ERC-20 implementation
        // The actual allowance update logic would reside in the calling facet
...
<LastUpdated date="2025-12-30T20:13:18.118Z" />
