...
import {IAccessControlTemporalFacet} from "@compose-protocol/diamond/facets/AccessControl/IAccessControlTemporalFacet.sol";
import {DiamondProxy} from "@compose-protocol/diamond/DiamondProxy.sol";

contract Deployer {
    // Assume diamondProxy is an already deployed DiamondProxy instance
    DiamondProxy diamondProxy;

    function grantTemporaryAdminRole(address _account, uint64 _expiry) public {
        address accessControlTemporalFacet = diamondProxy.getFacet(\"AccessControlTemporalFacet\");
        IAccessControlTemporalFacet(accessControlTemporalFacet).grantRoleWithExpiry(
            // Replace with actual role hash
    ...
    function checkRoleValidity(address _account) public view {
        address accessControlTemporalFacet = diamondProxy.getFacet(\"AccessControlTemporalFacet\");
        IAccessControlTemporalFacet(accessControlTemporalFacet).requireValidRole(
            // Replace with actual role hash
            bytes32(keccak256(\"ADMIN_ROLE\")),
            _account
        );
...
<LastUpdated date="2025-12-28T04:47:12.222Z" />
