...
contract MyFacet {
    ...
    /**
     * @notice Grants the ADMIN_ROLE to a new account.
     * @dev Requires the caller to have the ADMIN_ROLE.
     */
    function grantAdminRole(address _account) external {
        bytes32 ADMIN_ROLE = keccak256("ADMIN_ROLE");
        accessControl.requireRole(ADMIN_ROLE, msg.sender);
        accessControl.grantRole(ADMIN_ROLE, _account);
    }
     ...
     */
    function doesAccountHaveRole(bytes32 _role, address _account) external view returns (bool) {
...
<LastUpdated date="2025-12-30T20:13:10.303Z" />
