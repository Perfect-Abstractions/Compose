...
contract MinimalDiamond {
    ...
    function initialize(DiamondCutMod.FacetCut[] calldata _diamondCut, DiamondArgs calldata _args) public payable {
        DiamondCutMod.diamondCut(_diamondCut, _args.init, _args.initCalldata);
    }
