 ...
 */
contract ExportSelectors_ERC6909TransferFacet_Unit_Test is ERC6909TransferFacet_Base_Test {
    function test_ShouldReturnSelectors_ExportSelectors() external view {
        bytes memory selectors = facet.exportSelectors();
        bytes memory expected =
            abi.encodePacked(ERC6909TransferFacet.transfer.selector, ERC6909TransferFacet.transferFrom.selector);
