...
abstract contract ERC6909DataFacet_Base_Test is ERC6909_Test_Base {
    ERC6909DataFacet internal facet;

    function setUp() public virtual override {
        ERC6909_Test_Base.setUp();
        facet = new ERC6909DataFacet();
        vm.label(address(facet), "ERC6909DataFacet");
    }
}
