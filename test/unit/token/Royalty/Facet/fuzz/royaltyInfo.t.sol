 ...
 *  RoyaltyInfo
 */
contract RoyaltyInfo_RoyaltyFacet_Fuzz_Unit_Test is RoyaltyFacet_Base_Test {
    ...
    function testFuzz_RoyaltyInfo_OnlyTokenRoyalty(
        ...
        facet.setTokenRoyalty(tokenId, users.bob, feeNumerator);
    ...
    function testFuzz_RoyaltyInfo_DefaultAndTokenRoyalty_TokenOverridesDefault(
        ...
        facet.setDefaultRoyalty(users.alice, defaultFee);
        facet.setTokenRoyalty(tokenId, users.bob, tokenFee);
    ...
    function testFuzz_RoyaltyInfo_ZeroSalePrice_PreservesReceiver(uint96 feeNumerator, uint256 tokenId) external {
        ...
        (address receiver, uint256 royaltyAmount) = facet.royaltyInfo(tokenId, 0);
