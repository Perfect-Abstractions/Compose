...
import {ERC721EnumerableMintMod_Base_Test} from "test/unit/token/ERC721/Enumerable/ERC721EnumerableMintModBase.t.sol";
import {ERC721StorageUtils} from "test/utils/storage/ERC721StorageUtils.sol";

import "src/token/ERC721/Enumerable/Mint/ERC721EnumerableMintMod.sol";

/**
 *  @dev BTT spec: test/trees/ERC721.tree
 */
contract Mint_ERC721EnumerableMintMod_Fuzz_Unit_Test is ERC721EnumerableMintMod_Base_Test {
    ...
    function testFuzz_ShouldMintAndEnumerate_WhenValidInputs(address to, uint256 tokenId) external {
        ...
        assertEq(address(harness).allTokensLength(), 1, "allTokens length");
    }
}
