...
abstract contract AccessControlPausable_Base_Test is Base_Test {
    ...
    function seedPausedRole(address target, bytes32 role, bool paused) internal {
        target.setPausedRole(role, paused);
    }
}
