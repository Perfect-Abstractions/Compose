...
contract LibERC20Test is Test {
    ...
    function test_RevertWhen_BurnInsufficientBalance() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(ERC20Mod.ERC20InsufficientBalance.selector, alice, 50e18, 100e18));
        harness.burn(alice, 100e18);
    }

    function test_RevertWhen_BurnZeroBalance() public {
        vm.expectRevert(abi.encodeWithSelector(ERC20Mod.ERC20InsufficientBalance.selector, alice, 0, 1));
    ...
    function test_RevertWhen_ApproveZeroAddressSpender() public {
        vm.prank(alice);
        vm.expectRevert(abi.encodeWithSelector(ERC20Mod.ERC20InvalidSpender.selector, address(0)));
    ...
    function test_RevertWhen_TransferFromInsufficientAllowance() public {
        ...
        vm.prank(bob);
        vm.expectRevert(
            abi.encodeWithSelector(ERC20Mod.ERC20InsufficientAllowance.selector, bob, allowanceAmount, transferAmount)
        );
        harness.transferFrom(alice, charlie, transferAmount);
    }
    ...
    function test_RevertWhen_TransferFromInsufficientBalance() public {
        ...
        vm.prank(bob);
        vm.expectRevert(abi.encodeWithSelector(ERC20Mod.ERC20InsufficientBalance.selector, alice, balance, amount));
        harness.transferFrom(alice, charlie, amount);
    }
    ...
    function test_RevertWhen_TransferFromNoAllowance() public {
        ...
        vm.prank(bob);
        vm.expectRevert(abi.encodeWithSelector(ERC20Mod.ERC20InsufficientAllowance.selector, bob, 0, 100e18));
