...
contract LibERC721EnumerableTest is Test {
    ...
    function test_TransferFromRevertWhenNonexistent() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(LibERC721Enumerable.ERC721NonexistentToken.selector, tokenId));
        vm.prank(alice);
        harness.transferFrom(alice, bob, tokenId);
    }
    ...
    function test_TransferFromRevertWhenIncorrectOwner() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(LibERC721Enumerable.ERC721IncorrectOwner.selector, bob, tokenId, alice));
        vm.prank(alice);
    ...
    function test_TransferFromRevertWhenUnauthorized() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(LibERC721Enumerable.ERC721InsufficientApproval.selector, bob, tokenId));
        vm.prank(bob);
        harness.transferFrom(alice, charlie, tokenId);
    }
    ...
    function test_BurnUpdatesOwnership() public {
        uint256 tokenId = 1;
    ...
    function test_BurnUpdatesBalance() public {
        harness.mint(alice, 1);
        harness.mint(alice, 2);
    ...
    function test_BurnUpdatesOwnerTokens() public {
        harness.mint(alice, 1);
        harness.mint(alice, 2);
        harness.mint(alice, 3);
    ...
    function test_BurnUpdatesAllTokens() public {
        harness.mint(alice, 1);
        harness.mint(bob, 2);
        harness.mint(charlie, 3);
        ...
        assertEq(harness.tokenByIndex(0), 1);
        assertEq(harness.tokenByIndex(1), 3);
    }

    function test_BurnUpdatesIndices() public {
        harness.mint(alice, 1);
        harness.mint(alice, 2);
        harness.mint(alice, 3);
        ...
        // Verify indices are correct after burn
        assertEq(harness.tokenOfOwnerByIndex(alice, 0), 3);
        assertEq(harness.tokenOfOwnerByIndex(alice, 1), 2);
    }
    ...
    function test_BurnRevertWhenNonexistent() public {
        uint256 tokenId = 999;
    ...
    function test_BurnRevertWhenUnauthorized() public {
        uint256 tokenId = 1;
    ...
    function test_EnumerationAfterBurns() public {
        harness.mint(alice, 1);
        harness.mint(alice, 2);
        harness.mint(alice, 3);
    ...
    function test_BurnFuzz(address to, uint256 tokenId) public {
        ...
        assertEq(harness.ownerOf(tokenId), address(0));
        assertEq(harness.balanceOf(to), 0);
    }
}
