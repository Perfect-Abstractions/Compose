...
contract LibERC721EnumerableHarness {
    ...
    /**
     * @notice Exposes LibERC721Enumerable.transferFrom as an external function
     */
    function transferFrom(address _from, address _to, uint256 _tokenId) external {
        LibERC721Enumerable.transferFrom(_from, _to, _tokenId, msg.sender);
    }
    ...
    function balanceOf(address _owner) external view returns (uint256) {
        return LibERC721Enumerable.getStorage().ownerTokens[_owner].length;
    }
    ...
    function tokenOfOwnerByIndex(address _owner, uint256 _index) external view returns (uint256) {
        return LibERC721Enumerable.getStorage().ownerTokens[_owner][_index];
    }
    ...
    function setApprovalForAll(address _operator, bool _approved) external {
        LibERC721Enumerable.getStorage().isApprovedForAll[msg.sender][_operator] = _approved;
    }
